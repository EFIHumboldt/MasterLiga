...
import com.efihumboldt.appligas.databinding.FragmentPosicionesBinding
...
class PosicionesFragment : Fragment() {
    ...
    private var _binding: FragmentPosicionesBinding? = null
    ...
    override fun onCreateView( inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View
    {
        ...
        _binding = FragmentPosicionesBinding.inflate(inflater, container, false)
 ...
 swipeRefreshLayoutFragmentPosiciones.setOnRefreshListener {
     ...
     cargaDatosJob =  viewLifecycleOwner.lifecycleScope.launch {
         ...
         try {
             coroutineScope{
                 binding.progressBar.visibility = View.VISIBLE
                 val bannerDAO: BannerDAO = BannerDAOImpl(apiService.bannerApiService, bd, torneoSeleccionado.divisionID, requireContext())
                 val bannerService = BannerService(bannerDAO)
                 bannerList = bannerService.getBanners1ByDivisionID(viewModel.torneoSeleccionado!!.divisionID)
